...
const COLORS = ['#c0c1ff', '#4edea3', '#fa8c00', '#ffb4ab', '#ff33aa', '#ffcc02', '#00acfe', '#a78bfa']
...
export default function HabitsPage() {
  ...
  const [form, setForm] = useState({ title: '', icon: 'flame', color: '#c0c1ff', frequency: 'daily' as 'daily' | 'weekly' })
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      ...
                      <div>
                        ...
                        <span style={{
                          ...
                          color: habit.frequency === 'daily' ? '#c0c1ff' : '#fa8c00',
