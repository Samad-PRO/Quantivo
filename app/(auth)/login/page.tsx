          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              ...
              <input
                ...
                style={{ width: '100%', background: '#0b1326', border: '1px solid #464554', borderRadius: '8px', padding: '10px 12px', color: '#dae2fd', fontSize: '14px', outline: 'none', boxSizing: 'border-box' }}
              />
            </div>
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                <label style={{ fontSize: '13px', fontWeight: 500, color: '#dae2fd' }}>Password</label>
              </div>
              <input
